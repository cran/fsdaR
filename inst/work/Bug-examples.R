...
## Issue #1 -----------------------------------------------------
##
##  fsreg() crashes R. I have not tried thison different computers,
##      and R versions.
library(fsdaR)
...
##  function. The three sets of residuals are clearly seen for
##  virtually all efficiency values.
out <- fsreg(log.light~log.Te, data=starsCYG, method="MM")
